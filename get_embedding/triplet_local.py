# -*- coding: utf-8 -*-
"""
Created on Thu Oct 29 11:02:38 2020

@author: stanley
"""

import os
from data_local import get_train_pos, get_input, load_negative, eva
import numpy as np
...
negative_path = os.path.join('Negative_set',opts.negative_file)
